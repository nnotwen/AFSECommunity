// Data and State Management
    ...
    const _I = s('muteIcon');
        ...
        const championsData = [
            ...
            { name: "GOJO", chance: "0.0031%", cost: "7500 SHARDS", board: 1, desc: "Auto trains 125% Durability. Nerfs all player damage by 50% buffs all damage by 25% and increases your Chikara Per Min by x1.5" },
            { name: "LIGHT YAGAMI", chance: "0.003%", cost: "7500 SHARDS", board: 1, desc: "Auto trains 100% of your Chakra. Nerfs all player damage by 50% buffs all damage by 50% and increases your Chikara Per Min by x1.5" },
            { name: "SAITAMA SERIOUS", chance: "0.005%", cost: "7500 SHARDS", board: 1, desc: "Auto trains 150% of your Strength, 150% of your Durability. Nerfs all player damage by 50% buffs all damage by 100% increase your Chikara Per Min by x1.5, increases your Yen per Min by x1.25" },
            ...
            { name: "ACE", chance: "CHOPPER QUEST", cost: "EVENT ONLY", board: 3, desc: "Auto trains 140% of your Strength, 140% of your Durability. Nerfs all player damage by 50%, buffs all Damage by 25%, increases your Yen Per Min by x1.1, and prevents you from being stunned." },
